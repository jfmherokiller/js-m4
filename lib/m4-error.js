 ...
 */
M4Error.Message = {};
M4Error.Message[M4Error.Code.E_INV_RET] =
    'macro function `%s\' did not return a string';
M4Error.Message[M4Error.Code.E_NEST_LIMIT] =
    'too much macro nesting (max. %s)';
M4Error.Message[M4Error.Code.E_EOF_IN_STR] =
    'unexpected end of file in string (unmatched quote)';
M4Error.Message[M4Error.Code.W_TXT_UNDIV] =
    'non-number `%s\' in undivert arguments (forgot to enable extensions?)';
M4Error.Message[M4Error.Code.W_TOO_MANY_ARGS] =
